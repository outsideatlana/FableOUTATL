 ...
 * hardcoded. Renders only published entries. If there are none, the
 * section is hidden entirely (no fake/placeholder data).
 */
...
function HostedCard({ entry }: { entry: HostedRow }) {
  ...
  const className = 'group block bg-background p-6';
