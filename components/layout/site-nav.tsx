 ...
 * mono uppercase links, blue RSVP button. Brand lockup is the transparent
 * OutsideAtl logo followed by the OUTSIDEATL wordmark ("Atl" keeps the red
 * brand highlight). Logo is height-constrained with object-contain so its
 * square aspect ratio is never distorted; it shrinks on mobile so the
 * existing nav/RSVP layout is untouched.
 */
